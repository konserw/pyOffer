...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        self.action_new.setText(QCoreApplication.translate("MainWindow", u"Nowa", None))
        self.action_open.setText(QCoreApplication.translate("MainWindow", u"Otw\u00f3rz", None))
        self.action_save.setText(QCoreApplication.translate("MainWindow", u"Zapisz", None))
        self.action_exit.setText(QCoreApplication.translate("MainWindow", u"Wyj\u015bcie", None))
        self.action_PDF.setText(QCoreApplication.translate("MainWindow", u"PDF", None))
        self.action_print.setText(QCoreApplication.translate("MainWindow", u"Druk", None))
        self.action_about.setText(QCoreApplication.translate("MainWindow", u"O kOferta", None))
        self.action_about_Qt.setText(QCoreApplication.translate("MainWindow", u"O Qt", None))
        self.action_new_number.setText(QCoreApplication.translate("MainWindow", u"Nadaj nowy numer", None))
        self.push_button_add_merchandise.setText(QCoreApplication.translate("MainWindow", u"Dodaj Towar", None))
        ...
        self.check_box_query_number.setText(QCoreApplication.translate("MainWindow", u"Numer zapytania:", None))
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Pozosta\u0142e informacje", None))
        self.command_link_button_delivery.setText(QCoreApplication.translate("MainWindow", u"Warunki Dostawy", None))
        self.command_link_button_delivery_date.setText(QCoreApplication.translate("MainWindow", u"Termin Dostawy", None))
