...
#        self.gridLayout.addWidget(self.kolumny, 2, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_PDF.setText(QCoreApplication.translate("MainWindow", u"PDF", None))
        self.action_print.setText(QCoreApplication.translate("MainWindow", u"Print preview", None))
        self.action_about.setText(QCoreApplication.translate("MainWindow", u"About", None))
        self.action_about_Qt.setText(QCoreApplication.translate("MainWindow", u"About Qt", None))
        self.action_new_number.setText(QCoreApplication.translate("MainWindow", u"Set new offer symbol", None))
        self.push_button_add_merchandise.setText(QCoreApplication.translate("MainWindow", u"Add merchandise", None))
        self.push_button_discount.setText(QCoreApplication.translate("MainWindow", u"Set Discount", None))
        self.push_button_remove_row.setText(QCoreApplication.translate("MainWindow", u"Remove row", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("MainWindow", u"Offer table", None))
        self.command_link_button_customer.setText(QCoreApplication.translate("MainWindow", u"Choose customer", None))
        self.grup_box_query.setTitle(QCoreApplication.translate("MainWindow", u"Inquiry", None))
        self.check_box_query_date.setText(QCoreApplication.translate("MainWindow", u"Inquiry date:", None))
        self.push_button_query_date.setText("")
        self.check_box_query_number.setText(QCoreApplication.translate("MainWindow", u"Inquiry number:", None))
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Other information", None))
        self.command_link_button_delivery.setText(QCoreApplication.translate("MainWindow", u"Shipment terms", None))
        self.command_link_button_delivery_date.setText(QCoreApplication.translate("MainWindow", u"Delivery date", None))
        self.command_link_button_billing.setText(QCoreApplication.translate("MainWindow", u"Billing terms", None))
        self.command_link_button_offer.setText(QCoreApplication.translate("MainWindow", u"Offer terms", None))
        self.command_link_button_remarks.setText(QCoreApplication.translate("MainWindow", u"Remarks", None))
...
#        self.check_box_total_column.setText(QCoreApplication.translate("MainWindow", u"Warto\u015b\u0107", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QCoreApplication.translate("MainWindow", u"Other information", None))
        self.menu_offer.setTitle(QCoreApplication.translate("MainWindow", u"Offer", None))
